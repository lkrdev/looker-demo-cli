...
description: Central hub and decision engine for selecting, configuring, and authoring all Looker visualization options in LookML dashboards (.dashboard.lookml), including Cartesians, Tabular/KPI, Specialty/Maps, and Highcharts Advanced Vis Config (advanced_vis_config). Use when designing, building, or reviewing LookML dashboards.
---

# Looker Visualization Skills Suite (`looker-visualizations`)
